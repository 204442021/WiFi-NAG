...
class V20RestoreRegression(unittest.TestCase):
    def test_v4_1_v13_version_metadata(self):
        self.assertEqual(VERSION, "V4.1 V13")
        self.assertIn('<span class="version-badge">V4.1 V13</span>', UI)
        self.assertIn('id="diag-version">V4.1 V13</div>', UI)
        self.assertIn("mirrorDashboardText('fw-version','diag-version','V4.1 V13')", UI)
