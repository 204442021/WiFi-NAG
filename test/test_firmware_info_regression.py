...
class FirmwareInfoRegressionTests(unittest.TestCase):
    ...
    def test_version_file_is_single_v49_v13_source(self) -> None:
        self.assertEqual(self.version, "V4.9 V13")
        self.assertNotIn("3.0.0-beta.5", self.version)

    def test_release_facing_adaptive_version_is_v49_v13(self) -> None:
        ...
        self.assertIn("V4.9-V13", self.readme)
        self.assertIn("V4.9-V13", self.nag_operations)
        self.assertIn("V4.9 V13", self.ui_source)
        self.assertIn("V4.9 V13", self.ui_base)
